...
function aboutPage(): string {
  ...
  return `<!doctype html>
<html><head><meta charset="utf-8"><title>About Sheaf</title><style>${PAGE_CSS}</style></head>
<body><div class="wrap">
  <h1>Sheaf</h1>
...
function homePage(): string {
  return `<!doctype html>
<html><head><meta charset="utf-8"><title>Sheaf</title><style>${PAGE_CSS}${HOME_CSS}${SKY_FX_CSS}</style>${THEME_SCRIPT}</head>
<body class="home">
  ...
  <div class="home-foot">Sheaf · <a href="sheaf://about">version</a></div>
<script>
...
function welcomePage(): string {
  return `<!doctype html>
<html><head><meta charset="utf-8"><title>Welcome to Sheaf</title><style>${PAGE_CSS}${HOME_CSS}
...
<body class="home">
  ...
  <div class="wcard">
    ...
    <p style="font-size:12px;margin:0 0 18px">Stored on this machine only. Sheaf makes no network calls of its own.</p>
...
function helpPage(): string {
  const i = browserInfo()
  return `<!doctype html>
<html><head><meta charset="utf-8"><title>Help — Sheaf</title><style>${PAGE_CSS}
...
<body><div class="wrap" style="max-width:720px">
  <h1>Help</h1>
  <p class="tag">Sheaf ${escapeHtml(i.appVersion)}${i.isPackaged ? '' : ' (development)'} — a browser for development teams.</p>
